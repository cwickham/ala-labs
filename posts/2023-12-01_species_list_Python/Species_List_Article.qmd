...
We can return only species in Yass Valley on the New South Wales Conservation Status List (`dr650`) by adding the list ID `dataResourceUid=dr650` to `filters`. Our query returns 21 species.
